...
async def upload_file(
    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            print("StudentFileRecord columns:", StudentFileRecord.__table__.columns.keys())
...
def get_student_records(
    ...
    records = (
        ...
        .filter(
            StudentFileRecord.file_id == file_id
        )
        .all()
    )
